...
Intended to be used with [Retail Node Installer](https://github.com/intel/retail-node-installer), this Clear Linux OS profile contains a few files that ultimately will install Clear Linux OS to disk.
